...
executeMySQLStatement "$MYSQL_CONTAINER_NAME" "DROP DATABASE IF EXISTS trueta2;"
echo "[ OK ] Base de dades eliminada."

echo "[ INFO ] Creant la base de dades..."
executeMySQLStatement "$MYSQL_CONTAINER_NAME" "CREATE DATABASE trueta2;"
executeMySQLStatement "$MYSQL_CONTAINER_NAME" "GRANT ALL PRIVILEGES ON trueta2.* TO 'sail'@'%';"
